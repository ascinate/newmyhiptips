...
jQuery(document).ready(function() {
	...
	jQuery('.form-wizard-next-btn').click(function() {
		...
		var dept = $("#sources").val();
		var isValidn = count > 0;
		...
		parentFieldset.find('.wizard-required').each(function(){
            ...
            var checkvalue = checked = 0;
			
			$("#spnError")[0].style.display = isValid ? "none" : "block";

			if( $('#sources').is(':selected') ){
			$("#dError")[0].style.display = dept != '' ? "none" : "block";
			}
		...
		if(( nextWizardStep ) && (isValid || dept!='')) { 
...
$(document).ready(function () {
    $("#ckbCheckAll").click(function () {
		...
		$(".wizard-form-radio").toggleClass("active");
    });
});
